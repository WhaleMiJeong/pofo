        ...
        Parallax(){  
          ...
          let ParallaxObj = {
              ...
              section2(){
                    ...
                    let sec2ColTop    = $('#section2 .col').offset().top-$(window).height()-1000;
                      $(window).scroll(()=>{
                        //초기화설정
              ...
              section3(){
                      ...
                      let sec3ColTop    = $('#section3 .col').offset().top-$(window).height()-1000;
                        $(window).scroll(()=>{
                          //초기화설정
                          if( $(window).scrollTop() ==0 ){
              ...
              section6(){
                      const sec6     = $('#section6 .img-bg');
                      let sec6Top    = $('#section6 .img-bg').offset().top-$(window).height();
